        ...
        !(function (e) {
          ...
          function ae(t, i, r) {
            var c,
              ...
              z = {},
              _ = t.ownerDocument,
              D = i.documentElement || _.documentElement,
              $ = _.body,
              R = "rtl" === _.dir || 1 === i.ort ? 0 : 100;
            function N(e, t) {
            ...
            function B(e, t) {
              ...
              for (var s = 0; s < i.handles; s++)
                p.push(F(t, s)), (k[s] = s), x.push(j(n, e[s + 1]));
            }
            function H(e) {
              return (
          ...
          var le = { __spectrum: A, cssClasses: _, create: re };
          (e.create = re),
            (e.cssClasses = _),
            (e.default = le),
  ...
  (() => {
    ...
    class oe {
      constructor(...e) {
        ...
        (n.__swiper__ = !0),
          (n.support = z()),
          (n.device = _({ userAgent: i.userAgent })),
          (n.browser = I()),
          (n.eventsListeners = {}),
    ...
    class Ye extends ke {
      ...
      reset(e) {
        if (this.state !== Ae.Init && this.state !== Ae.Destroy) {
          this.stop("current");
          for (const e of ze) this.target[e] = je[e];
    ...
    const mt = [
      ...
      bt = {
        ...
        l10n: Object.assign(Object.assign({}, _e), {
          CLOSE: "Close",
          NEXT: "Next",
          PREV: "Previous",
    ...
    class Bt extends et {
      ...
      processType(e) {
        if (e.html) return (e.type = _t), (e.src = e.html), void (e.html = "");
        const t = this.instance.optionFor(e, "src", "");
    ...
    class Ni extends ke {
      ...
      onClick(e) {
        ...
        if (Math.abs(e.pageX - zi) > 30 || Math.abs(e.pageY - _i) > 30) return;
    ...
    if (
      ...
      let e = document.getElementById("slider"),
        t = document.getElementById("slider-input-start"),
        i = document.getElementById("slider-input-end"),
        n = Number(t.getAttribute("data-price-min")),
        s = Number(i.getAttribute("data-price-max"));
      fe.create(e, {
        start: [n, s],
        connect: !0,
        step: 1,
        ...
        e.noUiSlider.on("update", function (e, n) {
          (t.value = "от " + Math.ceil(e[0]) + "₽"),
            (i.value = "до " + Math.ceil(e[1]) + "₽");
        }),
              ...
              ? document
                  ...
                  .forEach((e) => {
                    e.closest(".product-event__add").classList.add("active"),
                      ji(e.closest(".product-event__add"));
                  })
              : (e.closest(".product-event__add").classList.add("active"),
                ji(e.closest(".product-event__add")));
          });
    ...
    for (const e of Vi) new qi(e);
    const Wi = new IntersectionObserver(
      function (e, t) {
        e.forEach((e) => {
          e.isIntersecting
            ? document
