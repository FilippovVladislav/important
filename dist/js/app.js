(() => {
  var e = {
      211: function (e, t) {
        !(function (e) {
          ...
          var le = { __spectrum: A, cssClasses: I, create: ae };
          (e.create = ae),
            (e.cssClasses = I),
            (e.default = le),
  ...
  (() => {
    ...
    for (let ln = 0; ln < Ji.length; ln++)
      Ji[ln].addEventListener("click", function (e) {
        e.preventDefault();
        const t = Ji[ln].getAttribute("href").substr(1);
        const i =
